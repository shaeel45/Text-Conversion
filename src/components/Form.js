...
<h2>{props.label}</h2>
  <textarea className="form-control" id="exampleFormControlTextarea1" rows="5" value={text} onChange={handleUpChange}></textarea>
</div>
...
<button className="btn btn-outline-success mx-2" onClick={changeCase()}>Clear Text</button>
